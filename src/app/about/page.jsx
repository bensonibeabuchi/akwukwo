        ...
        <div className="w-[1500px] mx-auto grid grid-cols-2 items-center ">
          <div className="pl-24 text-white space-y-2 py-4 ">
            ...
            <p className="text-white text-xl w-4/5">
              Learn the basics of Node.js and build scalable and efficient
              backend applications using JavaScript.
            </p>
            <p className="text-gray-400">By Emily Davis</p>
            <p>8 weeks</p>
            <p>Beginner</p>
            <Image src={fivestar} width={100} height={100} alt="fivestar" />
            <p className="text-[#286f6b] font-bold text-3xl">₦300,000</p>
          </div>
          <div className="pl-4 overflow-clip h-80">
            <Image src={slide2} width={700} height={300} alt="heroshot" />
          </div>
        </div>
      </div>
