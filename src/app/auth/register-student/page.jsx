...
import { useCreateStudentWithAuthMutation } from "@/redux/features/api/studentsApi";
import { useCreateLessonMutation } from "@/redux/features/api/coursesApi";


export default function RegisterStudentPage() {
  const router = useRouter();
  const [createStudent] = useCreateStudentWithAuthMutation();
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await createStudent({ first_name, last_name, email, password }).unwrap();
